...
const Login = () => {
    ...
    return (
        <div data-aos="fade-up" data-aos-delay="60" className="">
            <section className=" dark:bg-gray-900">
            <ToastContainer />
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <a data-aos="zoom-out" data-aos-delay="100" href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
